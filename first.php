...
<body background="images/background2.jpg" style="background-size: 100%">
	<!--<nav class="navbar navbar-expand-sm bg-light">
  <div class="container-fluid">
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link" href="compress_image.php">COMPRESS IMAGE</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="resize_image.php">RESIZE IMAGE</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="crop_image.php">CROP IMAGE</a>
      </li>
		<li class="nav-item">
        <a class="nav-link" href="convert_jpg.php">CONVERT JPG</a>
      </li>
		<li class="nav-item">
        <a class="nav-link" href="photo_editor.php">PHOTO EDITOR</a>
      </li>
		<li class="nav-item">
...
<div class="jumbotron text-center">
  <h2><b>Every tool you could want to edit images in bulk </b></h2>
  <h5>You online photo editor is here and forever free!</h5> 
</div>
